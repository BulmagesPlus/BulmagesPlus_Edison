...
#ifndef BLMAINCOMPANYPOINTER_H
#define BLMAINCOMPANYPOINTER_H
...
public:
    explicit BlMainCompanyPointer(BlMainCompany *mainCompany);
    BlMainCompanyPointer();
    virtual ~BlMainCompanyPointer();
    virtual void setMainCompany(BlMainCompany *);
    virtual BlMainCompany *mainCompany() const;
