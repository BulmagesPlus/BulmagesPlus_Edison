...
public:
    explicit BfBuscarFamilia(QWidget *parent = 0);
    ~BfBuscarFamilia();
    virtual QString codigocompletofamilia() const;
    virtual QString idfamilia() const;
    virtual QString nombrefamilia() const;
